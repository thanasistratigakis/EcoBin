...
extension AddFriendsViewController: UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if let followingUsers = followingUsers {
            ...
            cell.canFriend = !contains(followingUsers, user)
        }
...
extension AddFriendsViewController: FriendSearchTableViewCellDelegate {
...
//        removeObject(user, fromArray: &followingUsers)
        ...
        var hack: [PFUser] = followingUsers!
        removeObject(user, fromArray: &hack)
        self.followingUsers = hack
